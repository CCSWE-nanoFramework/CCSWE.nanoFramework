...
using UnitTests.CCSWE.nanoFramework.WebServer.Mocks.Controllers;
using UnitTests.CCSWE.nanoFramework.WebServer.Mocks.Middleware;
using UnitTests.CCSWE.nanoFramework.WebServer.Mocks.StaticFiles;
...
public class BootstrapperTests
{
    ...
    public void AddWebServer_registers_required_services()
    {
        ...
        using var webServer = serviceProvider.GetService(typeof(IWebServer)) as global::CCSWE.nanoFramework.WebServer.WebServer;
