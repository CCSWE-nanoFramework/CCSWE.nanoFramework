...
namespace CCSWE.nanoFramework.FileStorage.UnitTests.Internal;
[TestClass]
public class DefaultFileStorageTests
{
    ...
    private const string Destination = $"{Root}{nameof(DefaultFileStorageTests)}-Destination.test";
    private const string Source = $"{Root}{nameof(DefaultFileStorageTests)}-Source.test";
    ...
    public void Copy_copies_to_destination()
    {
        ...
        ExecuteTestAndTearDown(() =>
        {
            ...
            var sut = new DefaultFileStorage();
    ...
    */
    ...
    {
        Assert.IsFalse(File.Exists($@"I:\file_does_not_exist-{nameof(DefaultFileStorageTests)}.pretty_sure"));
    }
