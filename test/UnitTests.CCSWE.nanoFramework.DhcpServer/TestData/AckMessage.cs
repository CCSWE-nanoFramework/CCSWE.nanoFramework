...
namespace UnitTests.CCSWE.nanoFramework.DhcpServer.TestData;
internal static class AckMessage
{
    // ACK (1258F400): C8-E2-65-21-D2-84, flags: 0, yiaddr: 192.168.4.2, lease: 7199s, server: 192.168.4.1, options: {114: http://192.168.4.1/, 59: 01:44:59, 58: 00:59:59, 1: 255.255.255.0}
    ...
    public static readonly TimeSpan LeaseTime = TimeSpan.FromSeconds(7199);
    public static readonly MessageType MessageType = MessageType.Ack;
    ...
    public static readonly IPAddress ServerIdentifier = new([192, 168, 4, 1]);
    public static readonly IPAddress ServerIPAddress = new(0);
    public static readonly IPAddress SubnetMask = new([255, 255, 255, 0]);
    public const uint TransactionId = 307819520;
    public static readonly IPAddress YourIPAddress = new([192, 168, 4, 2]);
    ...
    [
        ...
        104, 116, 116, 112, 58, 47, 47, 49, 57, 50, 46, 49, 54, 56, 46, 52, 46, 49, 47, 59, 4, 155, 24, 0, 0, 58, 4,
        15, 14, 0, 0, 54, 4, 192, 168, 4, 1, 53, 1, 5, 1, 4, 255, 255, 255, 0, 51, 4, 31, 28, 0, 0, 255
    ];
}
