...
internal static class RequestMessage
{
    // REQUEST (1258F400): C8-E2-65-21-D2-84 jake, flags: 0, requested: 192.168.4.2, server: 192.168.4.1, options: {81: ??, 61: ??, 60: ??, 55: {1,3,6,15,31,33,43,44,46,47,119,121,249,252}}
    ...
    public static readonly MessageType MessageType = MessageType.Request;
    public static readonly Operation Operation = Operation.BootRequest;
    public static readonly IPAddress RequestedIPAddress = new([192, 168, 4, 2]);
    ...
    [
        ...
        1, 200, 226, 101, 33, 210, 132, 50, 4, 192, 168, 4, 2, 54, 4, 192, 168, 4, 1, 12, 4, 106, 97, 107, 101, 81,
        7, 0, 0, 0, 106, 97, 107, 101, 60, 8, 77, 83, 70, 84, 32, 53, 46, 48, 55, 14, 1, 3, 6, 15, 31, 33, 43, 44,
        46, 47, 119, 121, 249, 252, 255
    ];
}
