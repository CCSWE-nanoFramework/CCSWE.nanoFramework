...
using UnitTests.CCSWE.nanoFramework.Hosting.Mocks;
using DeviceHost=CCSWE.nanoFramework.Hosting.Internal.DeviceHost;

// ReSharper disable ObjectCreationAsStatement
namespace UnitTests.CCSWE.nanoFramework.Hosting.Internal;
[TestClass]
public class DeviceHostTests
{
    ...
    {
        Assert.ThrowsException(typeof(ArgumentNullException), () => new DeviceHost(new ServiceCollection().BuildServiceProvider(), null!));
    }
    ...
    public void ctor_throws_if_services_is_null()
    {
        ...
        Assert.ThrowsException(typeof(ArgumentNullException), () => new DeviceHost(null!, new ConsoleLogger()));
    }
