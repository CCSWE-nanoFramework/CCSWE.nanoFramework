...
namespace CCSWE.nanoFramework.Graphics.UnitTests;
...
public class HsbColorTests
{
    ...
    {
        var a = new HsbColor(180f, 50f, 75f, 255);
        var b = new HsbColor(180f, 50f, 75f, 128);

        Assert.IsFalse(a.Equals(b));
    }

    [TestMethod]
    public void Equals_should_return_false_for_different_brightness()
    {
        var a = new HsbColor(180f, 50f, 75f, 255);
        var b = new HsbColor(180f, 50f, 76f, 255);
    ...
    {
        var a = new HsbColor(180f, 50f, 75f, 255);
        var b = new HsbColor(181f, 50f, 75f, 255);
    ...
    {
        var a = new HsbColor(180f, 50f, 75f, 255);
        var b = new HsbColor(180f, 51f, 75f, 255);
    ...
    {
        var a = new HsbColor(180f, 50f, 75f, 255);
        var b = new HsbColor(180f, 50f, 75f, 255);
    ...
    public void Equals_should_return_true_for_values_within_tolerance()
    {
        ...
        var a = new HsbColor(180.0000f, 50.0000f, 75.0000f, 255);
        var b = new HsbColor(180.0005f, 50.0005f, 75.0005f, 255);
    ...
    public void GetHashCode_should_return_different_values_for_swapped_components()
    {
        ...
        var a = new HsbColor(120f, 50f, 75f, 255);
        var b = new HsbColor(50f, 120f, 75f, 255);
