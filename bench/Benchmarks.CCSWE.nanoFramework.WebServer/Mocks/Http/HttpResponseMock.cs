using System.IO;
using System.Net;
using Benchmarks.CCSWE.nanoFramework.WebServer.Mocks.IO;
using CCSWE.nanoFramework.WebServer.Http;

namespace Benchmarks.CCSWE.nanoFramework.WebServer.Mocks.Http;
...
internal class HttpResponseMock : HttpResponse
{
    ...
    public override Stream Body { get; } = new NullStream();
