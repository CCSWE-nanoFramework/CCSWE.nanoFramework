...
namespace Benchmarks.CCSWE.nanoFramework.Math;

public abstract class BenchmarkBase: Benchmarks.CCSWE.nanoFramework.BenchmarkBase
{
    protected const int Iterations = 250;
    protected const int Loops = 100;

    protected const double DoublePositive1 = FastMath.PI;
    protected const double DoublePositive2 = DoublePositive1 * 2;
    protected const double DoubleNegative1 = DoublePositive1 * -1;

    protected const float FloatPositive1 = (float)FastMath.PI;
